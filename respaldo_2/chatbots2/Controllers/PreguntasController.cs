...
namespace chatbots2.Controllers
{
    public class PreguntasController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Contenido")] Pregunta pregunta)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Contenido")] Pregunta pregunta)
        {
            if (ModelState.IsValid)
            {
